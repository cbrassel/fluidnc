...
properties =
   {
   spindleOnOffDelay: 4,        // time (in seconds) the spindle needs to get up to speed or stop, or laser/plasma pierce delay
   ...
   machineControl : "Grbl 1.1 / X-Pro V5",
...
function setCoolant(coolval)
   ...
   switch (coolval)
      ...
      case 6:
         if (coolantIsOn == 1)
            cresult = mFormat.format(9); // turn flood off
         cresult += ' ' + mFormat.format(7); // Vacuum
         coolantIsOn = 2;
         break;
